...
CREATE TABLE `GAME` (
	...
	`name v` varchar(45) DEFAULT NULL,
	`name h` varchar(45) DEFAULT NULL,
	...
	`c_v` varchar(3) DEFAULT NULL,
	`h_v` varchar(3) DEFAULT NULL,
	`e_v` varchar(3) DEFAULT NULL,
	`c_h` varchar(3) DEFAULT NULL,
	`h_h` varchar(3) DEFAULT NULL,
	`e_h` varchar(3) DEFAULT NULL,
	`id_stadium` varchar(3) DEFAULT NULL,
	`inning` varchar(3) DEFAULT NULL,
	`inning period` varchar(3) DEFAULT NULL,
	`first_base` varchar(2) DEFAULT NULL,
	`second_base` varchar(2) DEFAULT NULL,
	`third_base` varchar(2) DEFAULT NULL,
	`out` varchar(2) DEFAULT NULL,
